...
was #12's consequence until b4's int4 ladder landed and it stayed). **#21 was then paid, and
measuring it first found two live defects in the feature it was said to be missing** — so ten to
act on across thirteen rows, with #11, #16, #17 and #21 settled. #17 moved to §2 with what closed it, which is this file's own
