...
pub(crate) fn inspect(
    ...
    //
    // It reads a **running** driver too, since `Options::read_only`: no claim on the directory,
    // no log segment, no manifest edit. Until then this refused one, and before that it wrote
    // into it.
