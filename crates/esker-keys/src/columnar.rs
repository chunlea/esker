...
fn tag_of(ty: ColumnType) -> u8 {
    match ty {
        ...
        ColumnType::TsVector => 85,
        ColumnType::TsQuery => 86,
        ColumnType::TsVectorArray => 87,
        ColumnType::TsQueryArray => 88,
...
fn type_of(tag: u8) -> Result<ColumnType, RowError> {
    Ok(match tag {
        ...
        85 => ColumnType::TsVector,
        86 => ColumnType::TsQuery,
        87 => ColumnType::TsVectorArray,
        88 => ColumnType::TsQueryArray,
