...
use crate::keyspace::{physical_ranges, physical_ranges_of};
...
///
/// Which *ranges* of each family a region owns is [`crate::keyspace`]'s: one per physical
/// namespace, the mapping this module used to define and now shares with the split.
