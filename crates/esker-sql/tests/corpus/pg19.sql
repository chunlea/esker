...
CREATE TABLE t (a bigserial PRIMARY KEY);
CREATE TABLE t (a serial PRIMARY KEY, b bigserial);
CREATE TABLE t (a int8 GENERATED BY DEFAULT AS IDENTITY);
...
DROP INDEX CONCURRENTLY ci;
DROP INDEX CONCURRENTLY IF EXISTS ci;
...
SELECT esker_flashback('t', 'nightly');
